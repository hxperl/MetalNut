...
vertex SingleInputVertexIO oneInputUniformVertex(const device packed_float2 *position [[buffer(0)]],
                                          ...
                                          uint vid [[vertex_id]])
{
	...
	float4 newPos = uniform.modelMatrix * float4(position[vid], 0, 1.0);
    
	outputVertices.position = newPos;
